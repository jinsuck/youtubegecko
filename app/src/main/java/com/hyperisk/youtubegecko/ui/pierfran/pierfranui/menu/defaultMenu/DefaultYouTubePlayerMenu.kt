package com.hyperisk.youtubegecko.ui.pierfran.pierfranui.menu.defaultMenu
...
import com.hyperisk.youtubegecko.ui.pierfran.pierfranui.menu.MenuItem
import com.hyperisk.youtubegecko.ui.pierfran.pierfranui.menu.YouTubePlayerMenu
...
internal class DefaultYouTubePlayerMenu(private val context: Context) : YouTubePlayerMenu {
    ...
    override fun show(anchorView: View) {
        ...
        popupWindow?.showAsDropDown(anchorView, -context.resources.getDimensionPixelSize(R.dimen.ayp_8dp) * 12, -context.resources.getDimensionPixelSize(
            R.dimen.ayp_8dp) * 12)
